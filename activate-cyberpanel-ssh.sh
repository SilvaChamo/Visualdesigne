...
# Criar contas
/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName admin --password '***REMOVIDO***' 2>&1
echo "✓ Conta admin criada/ativada"

/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName suporte --password '***REMOVIDO***' 2>&1
echo "✓ Conta suporte criada/ativada"

/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName geral --password '***REMOVIDO***' 2>&1
...
SSH_COMMANDS
  ...
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName admin --password '***REMOVIDO***'"
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName suporte --password '***REMOVIDO***'"
  echo "/usr/local/CyberCP/bin/cyberpanel createEmail --domainName visualdesigne.com --userName geral --password '***REMOVIDO***'"
