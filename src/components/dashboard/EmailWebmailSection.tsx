        ...
        try {
          const res = await fetch('/api/read-email-detail', {
            ...
            body: JSON.stringify({
              ...
              password: emailOrigemPassword || (emailOrigem?.endsWith('@visualdesigne.com') ? '***REMOVIDO***' : ''),
    ...
    const carregar = async () => {
      ...
      try {
        ...
        if (todasAsContas) {
          ...
          const senhaImap = emailOrigemPassword || (emailOrigem?.endsWith('@visualdesigne.com') ? '***REMOVIDO***' : '')
  ...
  const handleForwardEmail = async () => {
    ...
    try {
      const res = await fetch('/api/forward-email', {
        ...
        body: JSON.stringify({
          email: emailOrigem,
          password: emailOrigemPassword || '***REMOVIDO***',
          emailId: modalEmail.id,
          forwardTo,
          folder: pastaActiva
        })
