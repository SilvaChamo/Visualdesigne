...
export function VisualWebBody() {
  ...
  return (
    <>
      ...
      <NotchSection shape="mid" bg="bg-white dark:bg-zinc-900" className="py-[30px]">
      ...
      <NotchSection shape="end" bg="bg-zinc-200 dark:bg-[#262626]" className="pt-[70px] pb-[70px]">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
      ...
      <NotchSection shape="end" bg="bg-white dark:bg-zinc-900" className="pt-16 pb-16 sm:pt-24 sm:pb-24">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
                    ...
                    return (
                      <div key={item.titleKey} className="flex flex-col gap-2">
                        <button
                          ...
                          className="w-full flex items-stretch text-left bg-white dark:bg-black/40 rounded-md overflow-hidden shadow-sm"
                        >
                        ...
                        <div className={`grid transition-all duration-300 ease-in-out ${isOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                          <div className="overflow-hidden">
                            <div className="px-4 py-8 text-sm text-black/70 dark:text-white/70 bg-white dark:bg-black/40 rounded-md shadow-sm">
                              {t(item.descKey)}
                            </div>
                          </div>
                        </div>
