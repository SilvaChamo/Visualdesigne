                ...
                return (
                  <div key={item.title} className="flex flex-col gap-2">
                    <button
                      ...
                      className="w-full flex items-stretch text-left bg-white dark:bg-white/10 dark:backdrop-blur-md rounded-md overflow-hidden shadow-sm"
                    >
                    ...
                    <div className={`grid transition-all duration-300 ease-in-out ${isOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                      <div className="overflow-hidden">
                        <div className="px-4 py-8 text-base text-black/70 dark:text-white/70 bg-white dark:bg-white/10 dark:backdrop-blur-md rounded-md shadow-sm">
                          {item.desc}
                        </div>
                      </div>
                    </div>
