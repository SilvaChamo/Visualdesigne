 ...
 *
 * Ordem (do mais avançado para o menos): done (tudo concluído) > delivered
 * (tudo pelo menos entregue, falta o remanescente nalgum) > approved (em
 * produção) > payment_selected (pago) > rejected > pending.
 */
